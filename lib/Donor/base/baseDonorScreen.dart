...
import 'package:qatra/Donor/base/baseController.dart';
import 'package:salomon_bottom_bar/salomon_bottom_bar.dart';

import 'package:qatra/theme/app_dark_theme.dart';

class baseDonorScreen extends StatefulWidget {
  const baseDonorScreen({Key? key}) : super(key: key);

  @override
  State<baseDonorScreen> createState() => _baseDonorScreenState();
}

class _baseDonorScreenState extends State<baseDonorScreen> {
  @override
  void initState() {
    super.initState();
